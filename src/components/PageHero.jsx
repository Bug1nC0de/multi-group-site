...
const PageHero = ({ 
  ...
  return (
    <section
      className={`hero ${bannerMode ? 'hero-banner cursor-pointer' : ''}`}
      onClick={handleClick}
      style={{
        ...
        minHeight: bannerMode ? '60vh' : '120vh'
      }}
    >
      {!hideText && <div className="hero-overlay"></div>}
      
      <div className="container hero-container relative z-10" onClick={(e) => bannerMode && e.stopPropagation()}>
        <div className="mb-6" onClick={(e) => e.stopPropagation()}>
          <Breadcrumbs />
        </div>

        {!hideText && (
          <div className="hero-content mx-auto md:mx-0 text-center md:text-left pb-40 md:pb-20">
            <motion.div
