  ...
  return (
    <footer className="border-t border-border pt-12 pb-12 relative z-10 overflow-hidden hero-pattern bg-bg-offset">
      <div className="container relative z-10">
        ...
        {/* Bottom Bar */}
        <div className="pt-20 flex flex-col md:flex-row justify-between items-center text-[9px] font-black uppercase tracking-[0.3em]" style={{borderTop: `1px solid ${blueBorder}`, color: blueColor, marginBottom: '1.5rem', gap: '1rem'}}>
