  ...
  return (
    <SolutionTemplate
      ...
      features={[
        ...
        { title: "Surveillance Networks", desc: "AI-powered CCTV, rugged mobile DVRs for fleets, and black box recorders for comprehensive visual intelligence.", icon: Camera },
        { title: "Asset Tracking", desc: "Real-time GPS and RF tracking for high-value cargo, vehicle fleets, and mobile assets.", icon: Navigation }
      ]}
      benefits={[
